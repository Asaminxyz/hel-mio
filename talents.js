...
const talents = [
  {
    ...
    summary:
      "NHKで朝のニュースキャスター、スポーツキャスター、報道レポーターとして経験を積み、現在は、フリーアナウンサーとベ企業やブランドのマーケティングPR支援で活動。フリーアナウンサーとしては、テレビリポーターをはじめ、大阪・関西万博やJリーグアウォーズといった大型イベントで、ファシリテーション・インタビューを担ってきた。報道現場で培った情報整理力と発信力を強みに、総裁選候補者のスピーチ指導にも対応。スポーツ現場から、報道、旅番組まで適応。",
