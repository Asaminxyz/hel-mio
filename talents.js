...
const talents = [
  {
    ...
    summary:
      "NHK地方局でニュースキャスター、スポーツキャスター、報道フィールドキャスターとして経験を積み、現在はテレビ、企業イベント、国際イベント、広報・マーケティングなど多方面で活躍。大阪・関西万博やJリーグアウォーズをはじめ、注目度の高い大型プロジェクトで司会・ファシリテーション・インタビューを担ってきた。報道現場で培った情報整理力と発信力を強みに、企業やブランドの広報支援、政治家・経営者のスピーチや登壇サポートにも対応。伝える内容の設計から表現、現場での届け方までを一貫して支援する。",
