const talents = [
...

  {
    ...
    summary:
      "新卒でラジオアナウンサーとしてキャリアをスタートし、その後、NHKの記者・キャスターとして、熊本、広島、鹿児島と10年以上にわたり活躍。安定した進行力と落ち着き、聞き手に安心感を与える声に定評があり、格式ある式典から親しみやすいステージまで柔軟に対応。保育士資格を活かし、子ども向けイベントでも温かく丁寧な進行を行う。",
