const talents = [
  {
    ...
    summary:
      "NHK地方局でニュースキャスター、スポーツキャスター、報道フィールドキャスターとして経験を積み、テレビリポーターのほか、大阪・関西万博やJリーグアウォーズをはじめ、大型プロジェクトで司会・インタビューを担った。報道現場で培った情報整理力を強みに、広報マーケターとして、企業支援、政治家・経営者のスピーチや登壇サポートにも対応。",
